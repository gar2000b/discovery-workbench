...
public class Template implements WorkbenchItem {
    ...
    public Template(Workspace workspace, float y, Color color1, Color color2, String label, TemplateType type, UUID uuid) {
        this(workspace, BOX_OFFEST_X, y, color1, color2, label, type, uuid);
    }

    public Template(Workspace workspace, float x, float y, Color color1, Color color2, String label, TemplateType type, UUID uuid) {
